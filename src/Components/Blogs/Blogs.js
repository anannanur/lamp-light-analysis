        ...
        <div className='container'>
            <div className="row mt-5">
                <div className="col-md-12">
                    <h1>1. Context API কি ? এটি কি কাজে লাগে ?</h1>
                ...
                <div className="col-md-12">
                    <h1>2. Inline, Block এবং Inline Block এর মধ্যে পার্থক্য কি ?</h1>
                    <p>Ans: Inline, Block এবং Inline Block এর মধ্যে পার্থক্যঃ
